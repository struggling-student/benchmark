    ...
    summary.update(
        {
            ...
            "memory_mode": "flat",
            "memory_mode_requested": "flat",
            "memory_mode_detected": "flat",
            "memory_mode_detection_method": "simulated_memory_only_numa_nodes",
            "memory_mode_verified": True,
            "memory_capacity_gib": 128.0 if uses_hbm else 512.0,
            "hbm_numa_nodes": [4, 5, 6, 7],
            "ddr_numa_nodes": [0, 1, 2, 3],
            "thread_count": 112,
            "process_count": 2,
            "thread_affinity": "compact, 56 threads/socket",
            "numa_policy": "local",
            "memory_binding": "hbm" if uses_hbm else "ddr",
            "memory_binding_resolved": "4-7" if uses_hbm else "0-3",
